...
fpanyusemarriedunmarriedbyresidencevisual <- read_csv("table8_fpanyusemarriedunmarriedbyresidence.csv") %>%
  ...
  rename(Indicator=Age_of_respondent)
# join the data
family_planning <- rbind(fpanyusemarriedbynumberofchildrenvisual, fpanyusemarriedunmarriedbyagevisual)

renderPlot({ggplot(family_planning, aes(x=Indicator, y=Percent, fill=Contraceptive_use)) + 
