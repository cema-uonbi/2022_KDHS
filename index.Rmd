...
interviewvisuals <-read_csv("data/table_1/table1_kdhshouseholdinterviews.csv") 


womeninterviews <-read_csv("data/table_1/table1_womeninterviewed.csv")

meninterviews <-read_csv("data/table_1/table1_meninterviewed.csv") 
