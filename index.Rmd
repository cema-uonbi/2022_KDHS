...
disabilitydata$Indicator <- fct_relevel(disabilitydata$Indicator, "Lowest", "Second", "Middle", "Fourth", "Highest",
 ...
 renderPlot({
  ...
  geom_bar(stat = "identity", position = position_dodge()) + 
     ...
     facet_grid(Participants~.)+
  theme_bw()+
  labs(y="Proportion (%)", x=paste0(unique(disabilitydata[disabilitydata$Indicator1==input$disability,]$Indicator2) ," of respondents"), fill="Disability") +
...
selectInput("physical_violence1", "",
              c("Experienced physical violence since age 15"="Percentage.who.have.experienced.physical.violence.since.age.15",
                "Experience physical violence often"="Often",
                "Experience physical violence sometimes"="Sometimes",
                "Experience physical violence often or sometimes"="Often.or.sometimes"), width=600)
