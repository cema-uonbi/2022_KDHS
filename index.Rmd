...
renderPlot({
  ...
  ggplot(RTA_county1)+
  geom_sf(data=RTA_county1, aes(geometry=geometry), fill=NA)+
...
renderPlot({if(input$occupation!="County"){
  ggplot(occupation[occupation$`Background characteristics`%in%input$occupation,],aes(x=reorder(`Category`,Proportion), y=Proportion, fill=`Value`))+
