...
renderGirafe({if(input$disability%in%"All"){
  disability_map1<-ggplot(data=disabilitydata[disabilitydata$Indicator1==input$disability,],aes(y=difficultyprop, x=reorder(difficulty, difficultyprop)) )+ geom_col(fill="brown")+
