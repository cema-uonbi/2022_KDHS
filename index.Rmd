...
renderPlot({
  ggplot(fertility_preferences[fertility_preferences$Desire_children%in%input$fertility,],aes(x=`Number of children`, y=Percent))+
...
renderPlot({
  ...
  geom_dotplot(binaxis='y', stackdir='center', binwidth = 3, fill="#4292c6")+
  theme_bw()+
