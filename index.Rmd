...
- This Shiny app uses data from the Key Indicators Report of the 2022 Kenya Demographic and Health Survey (2022 KDHS). The 2022 KDHS was implemented by the Kenya National Bureau of Statistics (KNBS) in collaboration with the Kenya's Ministry of Health (MOH) and other stakeholders.

- The app provides an easy-to-use interactive interface to explore the 2022 KDHS data using tools such as choropleth maps, bar plots, trend plots. 

- This is a living app that is continuously under development and improvement to include comparisons of the current demographic and health results with those from previous surveys, aimed at understanding Kenya's progress in attainment of health.
...
![](www/knbs_logo.png){width="40%"}}

<br>

![](www/moh_logo.png){width="40%"}
...
selectInput("teenage", "",
            c("Currently pregnant"="Currently pregnant",
...
vacc_data <- read_csv("vaccinations_countydata.csv") %>%
...
renderGirafe({
  ...
  geom_path( size= 2.5 ) + geom_point(size = 5) +
  theme_bw() + 
