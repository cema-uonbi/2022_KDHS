...
-   The App uses data from the 2022 Kenya Demographic and Health Survey report (2022 KDHS) [Link to the report](https://dhsprogram.com/publications/publication-FR380-DHS-Final-Reports.cfm) . The survey was implemented by the Kenya National Bureau of Statistics (KNBS) in collaboration with the Kenya's Ministry of Health (MoH) and other stakeholders.
...
renderGirafe({
 ...
 respondents_map2 <-respondentsdata%>%
  ...
  theme_bw() +
        facet_grid(~Participants) +
  geom_text(aes(label=label), hjust = -0.1, size=4, color="black")+
