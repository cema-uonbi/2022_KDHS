...
#               c("Number of Children"="Age",
#                 "Age"="Age_of_respondent",
#                 "Residence"="Residence",
#                 "Wealth quintile"="wealth quintile"))
# 
# selectInput("fp_type", "Type of family planning method",
#               c("Any"="Any",
...
#   rename(indicator1=Marital_status) %>%
...
# 
# # join the data
# family_planning <- rbind(fpanyusemarriedbynumberofchildrenvisual, fpanyusemarriedunmarriedbyagevisual, fpanyusemarriedunmarriedbyresidencevisual)
# 
# renderPlot({ggplot(family_planning[family], aes(x=Indicator, y=Percent, fill=Contraceptive_use)) + 
#   geom_bar(stat = "identity", position = "dodge") + 
#   theme_bw() +
#   #coord_flip() +
#   ylab("Percent (%)") + xlab("Number of Children") +
...
# 
# tradfpusmarriedbynumberofchildrenvisual <- read_csv("table8_tradfpusmarriedbynumberofchildren.csv") %>%
#   ggplot(aes(x=Contraceptive_use, y=Percent, fill=Number_of_children)) + 
#   geom_bar(stat = "identity", position = "dodge") + 
#   theme_bw() + 
#   coord_flip() +
#   ylab("Percent (%)") + xlab("Number of children") +
