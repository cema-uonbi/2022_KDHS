...
healthinsurancebyage <- read_csv("data/table_3/table3_healthinsurancebyage.csv") %>%
...
healthinsurancebyresidence <-read_csv("data/table_3/table3_healthinsurancebyresidence.csv") %>%
  tidyr::gather(Insurance,Coverage,2:7) %>%
  mutate(Insurance=recode(Insurance,"Any_health_insurance"="Form of health insurance", "None_DontKnow"="None/ Don't Know")) %>%
...
# Wealth quintile
healthinsurancebywealthquintile <- read_csv( "data/table_3/table3_healthinsurancebywealthquintile.csv") %>%
  tidyr::gather(Insurance,Coverage,2:7) %>%
  mutate(Insurance=recode(Insurance,"Any_health_insurance"="Form of health insurance", "None_DontKnow"="None/ Don't Know")) %>%
