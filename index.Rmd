...
valueBox(
  value = paste("89.3%"),
  caption = "of women who had a live birth /n in the 
2 years preceding the survey /n were delivered /n by a skilled provider
",
  color = "black"
)
```
...
valueBox(
  value = paste("82.3%"),
  caption = "of women who had a live birth /n in the 
2 years preceding the survey /n delivered /n in a health facility",
  color = "red"
)
```
...
valueBox(
  value = paste("66%"),
  caption = "of women who had a live birth /n in the 
2 years preceding the survey /n had 4+ /n ANC visits",
  color = "darkgreen"
)
``` 
...
hivc <- read_csv("table23_hiv_count_data.csv")%>%
  ...
  mutate(names1=paste0(County,", ", using_condoms,"%"))%>%
  mutate(names2=paste0(County,", ", limit_sex,"%"))%>%
  mutate(names3=paste0(County,", ", hivprevention_knowledge,"%")) %>%
  pivot_longer(c(limit_sex, using_condoms, hivprevention_knowledge), names_to = )

hivc1 <- full_join(county, hivc, by="County")
